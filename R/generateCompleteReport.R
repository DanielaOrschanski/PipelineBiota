...
generateCompleteReport <- function(patient_dir) {
  ...
  indice(patient_dir = patient_dir, path_metadata = sprintf("%s/Metadata-Completa-SinLimpiar.xlsx", pipe_data))
...
caratulaComplete <- function(patient_dir) {
  ...
  path_metadata <- sprintf("%s/Metadata-Completa-SinLimpiar.xlsx", pipe_data)
